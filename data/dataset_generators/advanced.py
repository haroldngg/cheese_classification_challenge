...
=======
            ...
            prompts[label] = [
                    ...
                    {"prompt": f"an image of {label} cheese in its package. The package should prominently display the name '{label}' in an elegant and readable font. The background should be plain to keep the focus on the cheese package",
                    "num_images": 40},
